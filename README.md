...
A UI for managing user privileges that natively interacts with our [Ego](https://github.com/overture-stack/ego) authentication and authorization microservice.
